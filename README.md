...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-or0qlg.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-or0qlg.containers.anotherwebservice.com/
...
```
git clone git@github.com:Coding4Hours/container-or0qlg.git
cd container-or0qlg
```
...
```
docker attach container-or0qlg
```
